    ...
    <div className="w-full max-w-sm">
      <div className="bg-white rounded-xl border border-[#e2e8f0] shadow-sm p-8">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-xl font-semibold text-[#1e293b]">Welcome back</h1>
          <p className="text-sm text-[#64748b] mt-1">Sign in to your TaskHI account</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-[#64748b]">
          ...
          <Link href="/register" className="text-[#6366f1] font-medium hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
